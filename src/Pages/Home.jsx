...
const TECH_STACK = ["React", "Javascript", "Typescript", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/lakshittt" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/lakshittt" },
];
